...
export const TextureKeys = {
  ...
  Explosion: 'explosion',
  CrystalEmerald: 'crystal-emerald',
  CrystalRuby: 'crystal-ruby',
...
export const TexturePaths = {
  ...
  [TextureKeys.MiddleEnemyStage2]: '/assets/enemies/middle-enemy-s2/spaceShips_006.png',
  ...
  [TextureKeys.CrystalEmerald]: '/assets/ui/crystals/emerald.png',
  [TextureKeys.CrystalRuby]: '/assets/ui/crystals/ruby.png',
  [TextureKeys.CrystalDiamond]: '/assets/ui/crystals/diamond.png',
...
export const SoundPaths = {
  ...
  [SoundKeys.Stage2Lance]: '/assets/audio/enemy/stage2_lance.ogg',
